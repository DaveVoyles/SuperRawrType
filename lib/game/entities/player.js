        ...
        EntityPlayer = EntityBaseActor.extend(
        {
            ...
            ******************************************/
            init: function(x, y, settings) {
                ...
                if (!ig.global.wm) {
                    ...
                    this.EnemySpawnerInst = ig.game.spawnEntity(EntityEnemySpawner, this.pos.x + 200, null);
            ...
            ******************************************/
            update: function() {
                ...
                if (ig.input.pressed('slowTime') || this.bSlowingTime) {
                    this.slowTime();
                    isSlowed = true;
                }
                else {
                ...
                if (this.joystick) {
                    ...
                    if (this.joystick.mouseDown) {
                        ...
                        if (this.currentMousePoint.y < this.mouseDownPoint.y -15) {
                            ...
                            this.vel.y = -idleSpeed;
                            this.accel.x = this.speed;
                        } else if (this.currentMousePoint.y > this.mouseDownPoint.y +15) {
                            // Moving down
                            this.vel.y = idleSpeed;
                            this.accel.x = this.speed;
                        } else {
            ...
            ******************************************/
            slowTime: function () {
                if (EntityPickupBulletTime.prototype.currentBulletTime <= EntityPickupBulletTime.prototype.maxBulletTime) {
                    ...
                    this.bulletTimeTimer = new ig.Timer(2);
                }
            },
