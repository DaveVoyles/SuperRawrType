        ...
        EntityPlayer = EntityBaseActor.extend(
            {
                ...
                ******************************************/
                ...
                update: function()
                {
                        ...
                        if (this.currentWeapLevel == 1){
                            switch (this.activeWeapon){
                                case("EntityBullet"):
                                    ...
                                    for (var i = 0; i < 5; i++) {
                                         ig.game.pool.useObject('bullet');
                                    }
                                   this.lastShootTimer.set(ig.game.bullet.fireRateWeak);
                    ...
                    // Increases weapon level (debug feature)
                    if (ig.input.pressed('increaseLevel')){
                         this.currentWeapLevel++;
                         if (this.currentWeapLevel > this.maxWeapLevels){
                            this.currentWeapLevel = 1;
                         }
                    }
                    ...
                    /*======================================
                     Spawning companion stationary ships 
                    ======================================*/
//                    // Spawning offset location of ships vs. player
//                    var offsetX = 20;
//                    var offsetY = 40;
//
//                    if(ig.input.pressed('spawnStationaryShip')&& EntityStationaryShip.prototype.bCanSpawnFirstShip == true){
//                        ig.game.spawnEntity(EntityStationaryShip, this.pos.x + this.offsetX, this.pos.y + this.offsetY);
//                        console.log('spawning stationary ship 1');
//                        EntityStationaryShip.prototype.bCanSpawnFirstShip = false;
//                        EntityStationaryShipBelow.prototype.bCanSpawnSecondShip = true;
//
//                    }
//
//                    if(ig.input.pressed('spawnStationaryShip')&& EntityStationaryShip.prototype.bCanSpawnSecondShip == true){
//                        ig.game.spawnEntity(EntityStationaryShip, this.pos.x + this.offsetX, this.pos.y + - this.offsetY);
//                        console.log('spawning stationary ship 1');
//                        EntityStationaryShipBelow.prototype.bCanSpawnSecondShip = false;
//
//                    }
