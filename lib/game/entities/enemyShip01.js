...
.defines(function () {
    ...
    EntityEnemyShip01 = EntityBaseActor.extend({
         ...
         ******************************************/
        update: function () {
            // kills the entity as soon as it's no longer in view of the screen window
            ...
            if (i > 0) {
                ...
                if (player.pos.x + 300 < this.pos.x) {
                    bCanShoot = true;
